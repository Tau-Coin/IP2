...
#define CONSTEXPR_SETTINGS
	...
	({{
		...
		SET(report_web_seed_downloads, true, nullptr),
		...
		SET(enable_ip_notifier, false, &session_impl::update_ip_notifier),
	...
	({{
		...
		SET(active_limit, 500, nullptr),
		DEPRECATED_SET(active_loaded_limit, 0, nullptr),
		...
		SET(dht_announce_interval, 15 * 60, nullptr),
        ...
        SET(i2p_port, 0, nullptr), //tau-modify
		...
		SET(dht_invoke_limit, 50, nullptr),
		SET(dht_invoke_window, 8, nullptr),
		...
		SET(dht_block_ratelimit, 100, nullptr),
		...
		SET(transport_invoking_interval, 50, nullptr),
