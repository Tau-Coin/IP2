...
#include "ip2/kademlia/items_db_sqlite.hpp"
#include "ip2/kademlia/bs_nodes_storage.hpp"
#include "ip2/kademlia/types.hpp"
...
namespace aux {
	...
	struct TORRENT_EXTRA_EXPORT listen_socket_t : utp_socket_interface
	{
			...
			, std::enable_shared_from_this<session_impl>
		{
			...
			friend struct ip2::invariant_access;
#endif
