...
TORRENT_VERSION_NAMESPACE_2
	...
	struct TORRENT_EXPORT peer_info
	{
		...
		using peer_flags_t = ip2::peer_flags_t;
		using peer_source_flags = ip2::peer_source_flags_t;
#endif
		...
		using connection_type_t = ip2::connection_type_t;
#endif
