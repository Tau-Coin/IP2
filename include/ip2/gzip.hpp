...
namespace gzip_errors {
	// ip2 uses boost.system's ``error_code`` class to represent errors. ip2 has
...
template<>
struct is_error_code_enum<ip2::gzip_errors::error_code_enum>
{ static const bool value = true; };

template<>
struct is_error_condition_enum<ip2::gzip_errors::error_code_enum>
{ static const bool value = true; };
