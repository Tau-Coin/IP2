...
// some messages in the network protocol. ip2 also uses it to store
...
#include "ip2/aux_/io_bytes.hpp" // for write_string
#include "ip2/aux_/string_util.hpp" // for is_digit
